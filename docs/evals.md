...
| Trigger routing, behavioural | 16/16 recall · 10/10 precision | over 26 probes ⚠️ small |
| Calibration examples | 0 | "a judge that doesn't agree with humans on a small labeled set is not a judge" ❌ |
| Cases sourced from an observed failure | 10 | "drawn from real failures" ⚠️ |
