...
#
# The number that matters is `cache_read`: the bill for a multi-agent run is
# re-reading context, not producing output, and an agent's output/cache_read
# ratio says whether it was thinking or re-reading.
set -euo pipefail
