...
keywords: [documentation, diagrams]
---
...
See [`examples.md`](examples.md) for ready-to-use templates, one per diagram type, worked on a single running subject so the shapes are comparable.
