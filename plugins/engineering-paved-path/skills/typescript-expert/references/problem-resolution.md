...
Reference for `typescript-expert`: the error patterns worth recognising, strict-mode migration,
and project references across a monorepo. Loaded on demand — the decision content stays in
`SKILL.md`.
